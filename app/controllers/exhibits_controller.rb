class ExhibitsController < ApplicationController
  ...
  private
    ...
    def exhibit_params
      params.require(:exhibit).permit(:name, :description, :insurance_cost, :age_of_creation, :collection_id, :height, :width, :length, :temp_control, :humidity_control, :people_security)
    end
end
