...
# Hall.create(roomname: "Зал древностей")
# Hall.create(roomname: "Древний Египет")
...
# Collection.first.halls << Hall.first
# Collection.first.halls << Hall.second
# Collection.second.halls << Hall.first
